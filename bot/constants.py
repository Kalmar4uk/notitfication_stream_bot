...
GET_USER_TWICH = "https://api.twitch.tv/helix/users?login={}".format(LOGIN)
GET_SCHEDULER_CHANNEL = (
    "https://api.twitch.tv/helix/schedule?broadcaster_id={}"
)
GET_STREAM_TWICH = (
    "https://api.twitch.tv/helix/streams?user_id={}".format(USER_ID)
)
GET_VIDEOS_TWICH = (
    "https://api.twitch.tv/helix/videos?user_id={}".format(USER_ID)
)
